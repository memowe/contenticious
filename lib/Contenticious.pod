...
Other modules might be configured from this configuration file. For example,
for configuring the Hypnotoad production server, the following parametres could
be added:
